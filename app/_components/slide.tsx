...
const SUB_DESC: Record<SubGroup, string> = {
  ...
  "02_01":
    "農家さんとのゲリラ開催したカボス詰め放題♪\n農薬・化学肥料不使用で今後もゲリラ開催予定♪",
  "02_02": "珈琲飲みながら可愛い雑貨をーー \n古道具屋さんとのコラボイベント",
  "02_03": "初の個展開催 \nオリジナルロンTもたくさんご予約頂きました",
  "02_04":
    "不定期で開催する夜カフェ。\n夜ならお仕事終わりでもゆっくり楽しんでいただけます。\nいつもと違った雰囲気をぜひお楽しみください。",
  "02_05":
    "植物屋さんをお招きしてコラボイベントし、\n珍しいものをたくさん持ってきていただきました",
  "02_06": "靴磨き職人をお招きしてコラボイベント",
  "02_07":
    "昆虫好きの息子によるイベント♪\n子供達同士でもコミュニティができたら嬉しいです",
  "02_08": "お金を稼ぐことの大変さを学んだ日でした",
  "02_09": "パラコードのワークショップ",
  "02_10": "当店が古着屋さんに。\nロゴデザインもカラーもオリジナルで！",
  "02_11": "豚汁屋さんの味噌玉と\nお花屋さんとの母の日コラボ",
  "02_12": "まさかの担々麺屋さんが当店に！\nこの日だけのスペシャルコース",

  "03_01": "壁面のローテーブルで読書タイムもぜひ",
  "03_02": "壁面のローテーブルは1人から3人までがオススメ",
  "03_03":
    "座り心地の良いハイチェアは作業もはかどるので\n珈琲と一緒に作業時間にも",
  "03_04": "当店はほとんどの席が\n2人掛けなので少人数にオススメのお店です",
  "03_05": "窓側のテーブル席のみ、\n3、4人でお座りいただけます",
  ...
  "05_01":
    "手軽にお家でも珈琲が楽しめる。\nドリップバッグは3種の飲み比べセットがオススメ",
  "05_02": "クリスマスバージョンデザインの\nドリップバッグ",
  "05_03": "プチギフトにオススメ",
  "05_04": "プチギフトにオススメ",
  "05_05": "ノベルティーでお渡していた\n限定ドリップバック",
  ...
  "07_01": "気まぐれで登場する\n米粉のシフォンはふわもちで好評♪",
  "07_02": "お家で簡単にアイスコーヒーが楽しめる\n水出し珈琲は夏季限定！",
  "07_03": "デカフェのチャイと相性抜群の豆乳ボンソイは\n女性に人気です",
